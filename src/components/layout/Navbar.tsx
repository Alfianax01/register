...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full h-[76px] bg-white/95 backdrop-blur-md border-b border-slate-200/90 shadow-2xs transition-all">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between">
        ...
        <Link
          href="/cari-e-ticket"
          className="inline-flex items-center gap-2 text-sm font-semibold text-primary bg-blue-50 hover:bg-blue-100 border border-blue-200/80 px-4 py-2.5 min-h-[44px] rounded-xl shadow-2xs transition-colors"
        >
