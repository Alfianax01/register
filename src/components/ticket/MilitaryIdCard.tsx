    ...
    >
      ...
      <div className="p-6 border-b border-slate-100 flex items-start justify-between bg-white">
        ...
        <div className="flex flex-col items-end gap-1">
          <span className="font-mono text-xs font-semibold text-slate-700 bg-slate-50 px-2.5 py-0.5 rounded-sm border border-slate-200">
      ...
      <div className="p-6 border-b border-slate-100 space-y-3.5 bg-white">
        ...
        <div className="grid grid-cols-2 gap-3 text-[13px] pt-1.5 border-t border-slate-100">
          <div>
            <span className="text-[#64748B] block text-xs uppercase font-medium">Jabatan Dinas</span>
            <span className="text-[#0F172A] font-medium block truncate">{guest?.jabatan || '-'}</span>
          </div>
          <div>
            <span className="text-[#64748B] block text-xs uppercase font-medium">Instansi / Satuan</span>
      ...
      {isCheckIn ? (
        <div className="p-5 grid grid-cols-2 gap-3 bg-white">
          <div className="p-3 rounded-md border border-slate-200 bg-slate-50/50 space-y-1">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-[#64748B] uppercase">
      ...
      <div className="px-6 py-3 border-t border-slate-100 bg-slate-50 flex items-center justify-between text-[12px]">
        <div>
          <span className="text-[#64748B] block text-xs uppercase font-medium">Waktu Registrasi</span>
        ...
        {isCheckIn ? (
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-800 bg-emerald-50 px-2 py-0.5 rounded-sm border border-emerald-200">
            <CheckCircle2 className="w-3 h-3 text-[#10B981]" />
            <span>CHECK-IN BERHASIL</span>
          </span>
        ) : (
          <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-amber-800 bg-amber-50 px-2 py-0.5 rounded-sm border border-amber-200">
