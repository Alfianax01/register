...
import { RotateCw, AlertTriangle, ArrowLeft, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto p-4 rounded-lg bg-emerald-50 border border-emerald-200 flex items-start gap-3 shadow-xs no-print">
        ...
        <div className="space-y-0.5">
          <h2 className="text-[14px] font-semibold text-emerald-950">
            Pendaftaran Berhasil & E-Ticket Resmi Aktif
          </h2>
          <p className="text-[12px] text-emerald-800 leading-relaxed">
            Kartu tanda peserta resmi Anda telah terbit. Tunjukkan kode QR atau cetak kartu ini untuk akses masuk ke Gedung Ahmad Yani.
          </p>
        </div>
      </div>
